...
kafka-topics.sh --create --topic weather-real-time --zookeeper ter_zookeeper:2181 --partitions 1 --replication-factor 1
...
kafka-topics.sh --create --topic weather-verified --zookeeper ter_zookeeper:2181 --partitions 1 --replication-factor 1
kafka-configs.sh --zookeeper ter_zookeeper:2181 --entity-type topics --entity-name weather-verified \
  --alter --add-config retention.ms=604800000

# topic API vilgilance
kafka-topics.sh --create --topic weather-alerts --zookeeper ter_zookeeper:2181 --partitions 1 --replication-factor 1
...
kafka-topics.sh --create --topic climatologique-status --zookeeper ter_zookeeper:2181 --partitions 1 --replication-factor 1
